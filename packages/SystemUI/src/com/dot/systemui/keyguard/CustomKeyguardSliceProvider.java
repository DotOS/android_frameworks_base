package com.dot.systemui.keyguard;
...
public class CustomKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        AddShadowTask(CustomKeyguardSliceProvider CustomKeyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(CustomKeyguardSliceProvider);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = CustomKeyguardSliceProvider.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            ...
            synchronized (this) {
                ...
                CustomKeyguardSliceProvider = (CustomKeyguardSliceProvider) mProviderReference.get();
            }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("CustomKeyguardSliceProvider#onBindSlice");
        Slice slice;
