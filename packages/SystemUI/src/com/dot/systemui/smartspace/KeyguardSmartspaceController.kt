package com.dot.systemui.smartspace
...
class KeyguardSmartspaceController @Inject constructor(
    ...
    init {
        if (!featureFlags.isSmartspaceEnabled()) {
            context.packageManager.setComponentEnabledSetting(ComponentName("com.android.systemui", "com.dot.systemui.keyguard.CustomKeyguardSliceProvider"), 1, 1)
        } else {
