...
public class QSAnimator implements Callback, PageListener, Listener, OnLayoutChangeListener,
    ...
    private void updateAnimators() {
        ...
        View brightnessContainer = mQsPanel.getBrightnessContainer();
        if (brightnessContainer != null && Utils.useQsMediaPlayer(null) && !mQsPanel.shouldUseHorizontalLayout()
            ...
            mBrightnessAnimator = new TouchAnimator.Builder().addFloat(brightnessContainer, "translationY", translation, 0)
                    .build();
            mAllViews.add(brightnessContainer);
        } else {
