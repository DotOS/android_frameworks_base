...
import static com.dot.packageinstaller.PackageUtil.getMaxTargetSdkVersionForUid;
...
public class InstallStart extends Activity {
    ...
    private boolean declaresAppOpPermission(int uid) {
        try {
            final String[] packages = mIPermissionManager.getAppOpPermissionPackages(Manifest.permission.REQUEST_INSTALL_PACKAGES);
            if (packages == null) {
                return false;
            }
